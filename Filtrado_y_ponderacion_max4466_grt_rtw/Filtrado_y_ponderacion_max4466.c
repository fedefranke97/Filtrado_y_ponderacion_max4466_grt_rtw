...
void Filtrado_y_ponderacion_max4466_step(void)
{
  ...
  sErr = GetErrorBuffer
    (&Filtrado_y_ponderacion_max44_DW.AudioDeviceReader_AudioDeviceLi[0U]);
  LibOutputs_Audio
    (&Filtrado_y_ponderacion_max44_DW.AudioDeviceReader_AudioDeviceLi[0U],
     &Filtrado_y_ponderacion_max446_B.AudioDeviceReader[0U], 5, 1024, 0);
  if (*sErr != 0) {
  ...
  for (i = 0; i < 1024; i++) {
    ...
    u0 -= -0.22455845805977917 *
      Filtrado_y_ponderacion_max44_DW.GeneratedFilterBlock_FILT_STATE[0];
    u0 -= 0.0126066252715464 *
      Filtrado_y_ponderacion_max44_DW.GeneratedFilterBlock_FILT_STATE[1];
    ...
    Filtrado_y_ponderacion_max44_DW.GeneratedFilterBlock_FILT_STATE[1] =
      Filtrado_y_ponderacion_max44_DW.GeneratedFilterBlock_FILT_STATE[0];
    Filtrado_y_ponderacion_max44_DW.GeneratedFilterBlock_FILT_STATE[0] = u0;
    u0 = numAccum;
    u0 -= -1.8938704947230705 *
      Filtrado_y_ponderacion_max44_DW.GeneratedFilterBlock_FILT_STATE[2];
    u0 -= 0.89515976909466144 *
      Filtrado_y_ponderacion_max44_DW.GeneratedFilterBlock_FILT_STATE[3];
    numAccum = u0;
    numAccum += -2.0 *
      Filtrado_y_ponderacion_max44_DW.GeneratedFilterBlock_FILT_STATE[2];
    ...
    Filtrado_y_ponderacion_max44_DW.GeneratedFilterBlock_FILT_STATE[3] =
      Filtrado_y_ponderacion_max44_DW.GeneratedFilterBlock_FILT_STATE[2];
    Filtrado_y_ponderacion_max44_DW.GeneratedFilterBlock_FILT_STATE[2] = u0;
    u0 = numAccum;
    u0 -= -1.9946144559930217 *
      Filtrado_y_ponderacion_max44_DW.GeneratedFilterBlock_FILT_STATE[4];
    u0 -= 0.99462170701408448 *
      Filtrado_y_ponderacion_max44_DW.GeneratedFilterBlock_FILT_STATE[5];
    numAccum = u0;
    numAccum += -2.0 *
      Filtrado_y_ponderacion_max44_DW.GeneratedFilterBlock_FILT_STATE[4];
    numAccum += Filtrado_y_ponderacion_max44_DW.GeneratedFilterBlock_FILT_STATE
    ...
    Filtrado_y_ponderacion_max44_DW.GeneratedFilterBlock_FILT_STATE[5] =
      Filtrado_y_ponderacion_max44_DW.GeneratedFilterBlock_FILT_STATE[4];
    Filtrado_y_ponderacion_max44_DW.GeneratedFilterBlock_FILT_STATE[4] = u0;
...
void Filtrado_y_ponderacion_max4466_initialize(void)
{
...

  {
    ...
    if (*sErr == 0) {
      LibCreate_Audio
        (&Filtrado_y_ponderacion_max44_DW.AudioDeviceReader_AudioDeviceLi[0U], 0,
         "Default", 1, 0, 1, 44100.0, 3, 1024, 10240, 1024, 5, NULL);
    }
...
void Filtrado_y_ponderacion_max4466_terminate(void)
{
  ...
  LibDestroy_Audio
    (&Filtrado_y_ponderacion_max44_DW.AudioDeviceReader_AudioDeviceLi[0U], 0, 1);
  DestroyHostLibrary
    (&Filtrado_y_ponderacion_max44_DW.AudioDeviceReader_AudioDeviceLi[0U]);
